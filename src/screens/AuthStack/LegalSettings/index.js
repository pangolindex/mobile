        ...
        <>
            ...
            <View style={{...styles.mainView,backgroundColor:'#FF6B00',paddingBottom:10,paddingTop:50, justifyContent:'space-between',padding:20}}>
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    ...
                    <Text style={{fontSize:20,color:'white'}}>Legal</Text>
                    <Text />
                </View>
             ...
             <ScrollView>
                 ...
                 <View style={{paddingTop:20,paddingBottom:5}}>
                     ...
                     <View style={styles.view1}>
                         <Text style={{fontWeight:'bold',paddingLeft:20}}>Acknowledgements</Text>
                     </View>
                 ...
                 <View style={{paddingTop:20,paddingBottom:5}}>
                     <View style={styles.viewAssests}>
                     <View style={styles.view1}>
                         <Text style={{fontWeight:'bold',paddingLeft:20}}>Terms of Service</Text>
                     </View>
                     <View style={{flexDirection:'row',justifyContent:'center',alignSelf:'center',}}>
                         <Text />
                         {/* <Text style={{justifyContent:'center',alignSelf:'center',color:'#929292'}}>  Main Wallet </Text> */}
