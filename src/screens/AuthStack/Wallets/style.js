...
const styles = ScaledSheet.create({
    ...
    viewAssests:{
        width:'100%',borderWidth:1,borderRadius:20,borderColor:'gray', height:120, padding:10,flexDirection:'row',justifyContent:'space-between',alignContent:'center'
    },
    doller:{
    ...
    view2:{
        justifyContent:'flex-start',width:'40%',justifyContent:'center'
    },
    view3:{
        justifyContent:'flex-start',width:'70%',justifyContent:'center'
    },
